...
const quotes = [
  {
    tag: "inspiration",
    body: "Love what you do. Keep pushing forward.",
    author: "Steve Jobs",
    dp: "https://randomuser.me/api/portraits/thumb/men/1.jpg",
  },
  {
    tag: "life",
    body: "Life is what happens while you're busy making other plans. Embrace each moment, cherish every second, and live fully and joyfully.",
    author: "John Lennon",
    dp: "https://randomuser.me/api/portraits/thumb/men/2.jpg",
  },
  {
    tag: "wisdom",
    body: "We will remember not the words of our enemies, but the silence of our friends.",
  ...
  return (
    <div className="body">
      <div className="content">
        <h1 id="serif">
          Discover the quotes <span>that will</span> touch{" "}
          <span>your life</span>
        </h1>
        <span>
  ...
  return (
    ...
    >
      ...
      <div className="quote-card-body">
        <div className="quote-card-body-text" id="serif">
          {body}
        </div>
      </div>
      <div className="quote-card-footer">
        ...
        <div className="quote-card-author">{author}</div>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="quotes">
      ...
      <div className="quote-indicator">
        <img
          src="https://raw.githubusercontent.com/Solarin-Johnson/freestyle/refs/heads/main/quotes/frame_2.webp"
          alt=""
        />
      </div>
      <div className="quote">
